...
export function CarCardList({
  ...
  return (
    <article
      className={cn(
        "group relative flex flex-col gap-4 rounded-xl bg-white p-4 shadow-md sm:flex-row",
    ...
    >
      ...
      <div className="flex flex-1 flex-col">
        ...
        {/* Title */}
        <h3 className="mb-2 font-semibold text-foreground-100 text-lg">
          {title}
        </h3>

        {/* Specs Row */}
        <div className="flex flex-wrap gap-x-3 gap-y-1 text-gray-600 text-sm">
      ...
      <div className="flex flex-row items-center justify-between gap-4 border-gray-100 border-t pt-4 sm:flex-col sm:items-end sm:justify-center sm:border-t-0 sm:border-l sm:pt-0 sm:pl-4">
        {/* Price */}
        <p className="font-bold text-2xl text-foreground-200">
